...
function digg(type, id, bury) {
    ...
    if(small_button) $('d'+id).innerHTML = "<h3><img src='/statics/images/spinner.gif'/><br/><span>...</span></h3>";

    if($('digg_bottom')){
      $$('#digg_bottom div').each(function(div){div.innerHTML="<img src='/statics/images/spinner.gif'/>";});
...
function bury_blog(blog_id) {
    $('b' + blog_id).innerHTML = "<h3><img src='/statics/images/spinner.gif'/><br/><span>...</span></h3>";

...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="../../statics/css/weixinqr.css" />
    <script src="../../statics/js/wxlogin.js"></script>
...
<div class="main" style="background:url(../../statics/images/login-bg.png)">
    <div class="container container-custom">
        <div class="row wrap-login">
            <div class="login-banner col-sm-6 col-md-7 col-lg-7 hidden-xs"><a href="https://edu.csdn.net/huiyiCourse/series_detail/79?utm_source" target="_blank"><img src="../../statics/picture/login-banner.png"  class="img-responsive"></a></div>
                ...
                <div class="login-part">
                    ...
                    <div class="user-info">
                    	...
                    	<span class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                        	...
                        	<a href="https://passport.csdn.net/account/fpwd?action=forgotpassword&service=http%3A%2F%2Fwww.csdn.net%2F" tabindex="5">忘记密码</a>
                        </span>
                                </div>
                                ...
                                <input type="hidden" name="lt" value="LT-213287-0LxeTFpPmofnts2SiWZgEpICmZ9jcZ" />
                    ...
                    <div class="third-part tracking-ad" data-mod="popu_27">
                        ...
                        <script src="../../statics/js/weixinqr.js" type="text/javascript"></script>
                        ...
                        <div class="register-now"><span>还没有PG帐号？</span>
                            <span class="register tracking-ad" data-mod="popu_28">
	                	<a href="https://passport.csdn.net/account/mobileregister?action=mobileRegister&service=http%3A%2F%2Fwww.csdn.net%2F"  data-kuick='{"act":"csdn05","desc":"立即注册"}'>立即注册</a>
	                </span>
                        </div>
                    </div>
                </div>
...
<script data-main="https://csdnimg.cn/release/passport/history/js/login-config.js?v=1.1.8" src="../../statics/js/require.js" type="text/javascript"></script>
<script src="../../statics/js/publib_footer-1.0.2.js" type="text/javascript"></script>

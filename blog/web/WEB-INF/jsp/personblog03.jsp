...
<head>
    ...
    <title>${information.iTitle} - pg博客</title>
...
<div class="container clearfix">
    <main>
        ...
        <article>
            <h1 class="csdn_top">${information.iTitle}</h1>
            <div class="article_bar clearfix">
                <div class="artical_tag">
                <span class="original">
                    ${information.iTab} </span>
                    <span class="time"><fmt:formatDate value="${information.iCreateTime}" type="date"
                ...
                <ul class="right_bar">
                    <li>
                        <button class="btn-noborder"><i class="icon iconfont">阅读量</i><span class="txt">${information.iView}</span>
                        </button>
                    </li>
                    <li class="edit">
                ...
                <a href="//blog.csdn.net/u014029255/article/details/50457111" target="_blank"
                   strategy="BlogCommendFromQuerySearch_1">
                    <dd>
                        ...
                        <ul>
                            <li class="avatar_img"><img src="${information.iImg}" alt="${information.iAuthor}"
                                                        title="${information.iAuthor}"></li>
                            <li class="user_name">${information.iAuthor}</li>
                            <li class="time">${information.iCreateTime}</li>
    ...
    <aside>
        <div class="right_box user_info">
            <dl class="inf_bar clearfix">
                <dt class="csdn-tracking-statistics tracking-click" data-mod="popu_381">
                    <a href="//blog.csdn.net/egefcxzo3ha1x4" target="_blank">
                        <img src="${information.iImg}" class="avatar_pic">
                    </a>
                </dt>
                <dd>
                    <h3 class="csdn-tracking-statistics tracking-click" data-mod="popu_380"><a
                            href="//blog.csdn.net/egefcxzo3ha1x4" target="_blank" id="uid">${information.iAuthor}</a></h3>
            ...
            <div class="inf_number_box clearfix">
                ...
                <dl title="74">
                    <dt>粉丝</dt>
                    <dd id='fan'>${information.iFollower}</dd>
                </dl>
                <dl title="121">
                    <dt>喜欢</dt>
                    <dd>${information.iLike}</dd>
                </dl>
                <dl title="235">
                    <dt>评论</dt>
                    <dd>${information.iDiscuss}</dd>
                </dl>
            </div>
        ...
        <div class="interflow clearfix">
            ...
            <div class="gradeAndbadge gradewidths" title="3158">
                <span>积分：</span>
                <span class="num odd-overhidden">${information.iIntegration}</span>
            </div>
            <div class="gradeAndbadge gradewidths" title="13274">
                <span>排名：</span>
                <span class="num odd-overhidden">${information.iRanking}</span>
            </div>

                    ...
                    <div id="myCarousel" class="slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            ...
                            <div class="carousel-item csdn-tracking-statistics " data-mod="popu_465" data-dsm="post">
                                <a href="http://blog.csdn.net/Blockchain_lemon/article/details/79524017"
                                   target="_blank">
                            ...
                            <div class="carousel-item csdn-tracking-statistics " data-mod="popu_465" data-dsm="post">
                                <a href="http://blog.csdn.net/dqcfkyqdxym3f8rb0/article/details/79501136"
                                   target="_blank">
                            ...
                            <div class="carousel-item csdn-tracking-statistics " data-mod="popu_465" data-dsm="post">
                                <a href="http://blog.csdn.net/blockchain_lemon/article/details/79479297"
                                   target="_blank">
           ...
           <%-- <div class="feed-fix-box">
            ...
            <ul class="feedlist_mod" id="feedlist_id" shown-offset="1520902233852052">
                <c:forEach items="${newsList}" var="newsList" varStatus="s">
                    <li class="clearfix" data-type="blog" data-id="79442462" id="newspaper">
                        <div class="list_con">
                            <div class="title">
                                <h2 class="csdn-tracking-statistics" data-mod="popu_459" data-poputype="feed"
                                    data-feed-show="false" data-dsm="post">
                                    <a strategy="recommend" href="/personal/personblog?nid=${newsList.nid}"
                                       target="_blank">
                                            ${newsList.ntitle} </a>
                                </h2>
                                <div class="close_tag">
                ...
                <li  id="last" style="font: 14px arial;color: red;width: 100%;text-align: center"><a style="font: 14px arial;color: red;width: 100%;text-align: center">刚刚阅读在这里，点击刷新</a>
                    ...
                    <div class="read-here csdn-tracking-statistics" data-mod="popu_464" data-dsm="post" id="last">
                        <a>刚刚阅读在这里，点击刷新</a>
                    </div>--%>
                </li>
            </ul>

...
<html lang="en" style="overflow: hidden;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <script src="../../statics/js/require.js" data-main="http://static.blog.csdn.net/mdeditor/public/res-min/main_new.js?201802261444"></script>
    <script type="text/javascript" src="../../statics/js/first_guide-06c52b327b.js"></script>
    <script type="text/javascript" charset="utf-8" async="" data-requirecontext="_" data-requiremodule="http://static.blog.csdn.net/mdeditor/public/res-min/main_new.js?201802261444" src="../../statics/js/main_new.js"></script><link type="text/css" rel="stylesheet" href="../../statics/css/defaults.css"><script type="text/x-mathjax-config;executed=true">MathJax.Hub.Config({
...
</script><script type="text/javascript" charset="utf-8" async="" data-requirecontext="_" data-requiremodule="mathjax" src="../../statics/js/MathJax.js"></script><style type="text/css">@media (min-width: 0px) {
        #wmd-input {
            font-size: 16px;
        }
        #preview-contents {
    ...
    .MathJax_PHTML .noError {vertical-align:0; font-size: 90%; text-align: left; color: black; padding: 1px 3px; border: 1px solid}
    ...
    @font-face {font-family: MathJax_Main; src: url('http://static.blog.csdn.net/mdeditor/public/res/bower-libs/MathJax/fonts/HTML-../../statics/TeX/woff/MathJax_Main-Regular.woff?V=2.7.2') format('woff'), url('http://static.blog.csdn.net/mdeditor/public/res/bower-libs/MathJax/fonts/HTML-../../statics/TeX/otf/MathJax_Main-Regular.otf?V=2.7.2') format('opentype')}
    @font-face {font-family: MathJax_Main-bold; src: url('http://static.blog.csdn.net/mdeditor/public/res/bower-libs/MathJax/fonts/HTML-../../statics/TeX/woff/MathJax_Main-Bold.woff?V=2.7.2') format('woff'), url('http://static.blog.csdn.net/mdeditor/public/res/bower-libs/MathJax/fonts/HTML-../../statics/TeX/otf/MathJax_Main-Bold.otf?V=2.7.2') format('opentype')}
    @font-face {font-family: MathJax_Main-italic; src: url('http://static.blog.csdn.net/mdeditor/public/res/bower-libs/MathJax/fonts/HTML-../../statics/TeX/woff/MathJax_Main-Italic.woff?V=2.7.2') format('woff'), url('http://static.blog.csdn.net/mdeditor/public/res/bower-libs/MathJax/fonts/HTML-../../statics/TeX/otf/MathJax_Main-Italic.otf?V=2.7.2') format('opentype')}
    @font-face {font-family: MathJax_Math-italic; src: url('http://static.blog.csdn.net/mdeditor/public/res/bower-libs/MathJax/fonts/HTML-../../statics/TeX/woff/MathJax_Math-Italic.woff?V=2.7.2') format('woff'), url('http://static.blog.csdn.net/mdeditor/public/res/bower-libs/MathJax/fonts/HTML-../../statics/TeX/otf/MathJax_Math-Italic.otf?V=2.7.2') format('opentype')}
    @font-face {font-family: MathJax_Caligraphic; src: url('http://static.blog.csdn.net/mdeditor/public/res/bower-libs/MathJax/fonts/HTML-../../statics/TeX/woff/MathJax_Caligraphic-Regular.woff?V=2.7.2') format('woff'), url('http://static.blog.csdn.net/mdeditor/public/res/bower-libs/MathJax/fonts/HTML-../../statics/TeX/otf/MathJax_Caligraphic-Regular.otf?V=2.7.2') format('opentype')}
    @font-face {font-family: MathJax_Size1; src: url('http://static.blog.csdn.net/mdeditor/public/res/bower-libs/MathJax/fonts/HTML-../../statics/TeX/woff/MathJax_Size1-Regular.woff?V=2.7.2') format('woff'), url('http://static.blog.csdn.net/mdeditor/public/res/bower-libs/MathJax/fonts/HTML-../../statics/TeX/otf/MathJax_Size1-Regular.otf?V=2.7.2') format('opentype')}
    @font-face {font-family: MathJax_Size2; src: url('http://static.blog.csdn.net/mdeditor/public/res/bower-libs/MathJax/fonts/HTML-../../statics/TeX/woff/MathJax_Size2-Regular.woff?V=2.7.2') format('woff'), url('http://static.blog.csdn.net/mdeditor/public/res/bower-libs/MathJax/fonts/HTML-../../statics/TeX/otf/MathJax_Size2-Regular.otf?V=2.7.2') format('opentype')}
    @font-face {font-family: MathJax_Size3; src: url('http://static.blog.csdn.net/mdeditor/public/res/bower-libs/MathJax/fonts/HTML-../../statics/TeX/woff/MathJax_Size3-Regular.woff?V=2.7.2') format('woff'), url('http://static.blog.csdn.net/mdeditor/public/res/bower-libs/MathJax/fonts/HTML-../../statics/TeX/otf/MathJax_Size3-Regular.otf?V=2.7.2') format('opentype')}
    @font-face {font-family: MathJax_Size4; src: url('http://static.blog.csdn.net/mdeditor/public/res/bower-libs/MathJax/fonts/HTML-../../statics/TeX/woff/MathJax_Size4-Regular.woff?V=2.7.2') format('woff'), url('http://static.blog.csdn.net/mdeditor/public/res/bower-libs/MathJax/fonts/HTML-../../statics/TeX/otf/MathJax_Size4-Regular.otf?V=2.7.2') format('opentype')}
    .MathJax .noError {vertical-align:0; font-size: 90%; text-align: left; color: black; padding: 1px 3px; border: 1px solid}
    </style><style type="text/css">@font-face {font-family: MathJax_AMS; src: url('http://static.blog.csdn.net/mdeditor/public/res/bower-libs/MathJax/fonts/HTML-../../statics/TeX/woff/MathJax_AMS-Regular.woff?V=2.7.2') format('woff'), url('http://static.blog.csdn.net/mdeditor/public/res/bower-libs/MathJax/fonts/HTML-../../statics/TeX/otf/MathJax_AMS-Regular.otf?V=2.7.2') format('opentype')}
    </style></head>

<body style="overflow: hidden;"><div style="visibility: hidden; overflow: hidden; position: absolute; top: 0px; height: 1px; width: auto; padding: 0px; border: 0px; margin: 0px; text-align: left; text-indent: 0px; text-transform: none; line-height: normal; letter-spacing: normal; word-spacing: normal;"><div id="MathJax_Hidden"></div></div><div id="MathJax_Message" style="display: none;"></div><div class="switchDOM " data-poputype="feed" data-feed-show="false" style="height: 35px; background: rgb(250, 250, 250); box-shadow: rgba(0, 0, 0, 0.1) 0px 1px 2px 0px; margin-bottom: 1px;">                      <div class="switch-text" style="padding-left:150px;padding-right:16px;"><span style="line-height:35px;font-size: 14px;color: #4F4F4F;"><span style="color:red">严禁讨论涉及中国之军/政相关话题，违者会被禁言、封号!</span></span>                        <div class="switch-bottom csdn-tracking-statistics" style="float:right">                          <a class="switch-old" href="javascript:void(0);" style="padding-bottom: 5px;padding-top: 5px;line-height:35px;font-size:12px;padding-left:10px;padding-right:10px;" target="_self">去旧版</a>                          <a class="switch-new switch-activation" href="javascript:void(0);" style="padding-bottom: 5px;padding-top: 5px;line-height:35px;font-size:12px;padding-left:10px;padding-right:10px;" target="_self">新版</a>                        </div>                      </div>                      <style>                      .switch-old,.switch-new,.switch-new:link,.switch-new:visited,.switch-old:link,.switch-old:visited{color:#999;}                      body .switch-activation{border-radius: 16px;background-color: #5B5B5B;color:#fff !important}                      body .switch-old:hover,body .switch-new:hover{color: #4F4F4F;}                      body .switch-activation:hover{color:#999;}                       </style>                    </div><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="position: absolute; width: 0; height: 0" id="__SVG_SPRITE_NODE__"><symbol class="icon" viewBox="0 0 1024 1024" id="logo">
    <defs>
    </defs>
...
</symbol><symbol class="icon" viewBox="0 0 1024 1024" id="pencil"><defs><style type="text/css"></style></defs><path d="M128 817.6l44.8-192 136 144-180.8 48z m214.4-84.8l-136-144 406.4-430.4 134.4 144-404.8 430.4z m438.4-467.2l-136-144L745.6 14.4c19.2-19.2 49.6-19.2 67.2 0l67.2 72c19.2 19.2 19.2 51.2 0 72l-99.2 107.2zM976 1024H48c-27.2 0-48-22.4-48-51.2s20.8-51.2 48-51.2h928c27.2 0 48 22.4 48 51.2s-20.8 51.2-48 51.2z" fill="" p-id="5022"></path></symbol></svg>
            ...
            <ul class="navbar-nav-md">
                <li class="nav-item nav-avatar">
                    <a href="http://blog.csdn.net/weixin_41338470" target="_blank">
                        <img class="nav-avatar-img" src="writeblogImages/3_weixin_41338470.jpg" width="56" height="56">
                    </a>
                </li>
                <li class="nav-item header-ucenter  d-flex align-items-center flex-column">
                    <div class="top d-flex align-items-center">
                        <a href="http://blog.csdn.net/weixin_41338470" class="header-ucenter-uname">weixin_41338470</a>
                        <a class="header-ucenter-logout" href="http://passport.csdn.net/account/logout?ref=toolbar">退出</a>
                    </div>
                </li>
            </ul>
        </div>
...
<main id="meditor_box">
    ...
    <div id="editorBox" style="position: relative; width: 1600px; height: 519.422px;">
        <div id="csdnEditor" class=" ltr" style="position: absolute; top: 0px; left: 0px; bottom: 0px; right: 0px; overflow: hidden;"><div class="layout-wrapper-l1" style="transform: translate(0px, 0px); width: 1600px; height: 519px;">
                ...
                <div class="navbar navbar-default">
                    <div class="navbar-inner">
                        ...
                        <ul class="nav pull-right right-buttons">
                            ...
                            <li class="extension-buttons" style="display:none"><div class="btn-group"><a class="btn btn-success button-publish" title="Update document publication"><i class="icon-upload"></i></a></div></li>
                            <!-- <li>
                        ...
                        <ul class="nav left-buttons">
                            <li class="wmd-button-group1 btn-group"><li class="wmd-button btn btn-success" id="wmd-bold-button" title="加粗 &lt;strong&gt; Ctrl/Cmd+B" style="left: 0px;"><span style="background-position: 0px 0px; display: none;"></span><i class="icon-bold"></i></li><li class="wmd-button btn btn-success" id="wmd-italic-button" title="斜体 &lt;em&gt; Ctrl/Cmd+I" style="left: 0px;"><span style="background-position: -20px 0px; display: none;"></span><i class="icon-italic"></i></li><li class="wmd-button btn btn-success" id="wmd-link-button" title="Hyperlink &lt;a&gt; Ctrl/Cmd+L" style="left: 0px;"><span style="background-position: -40px 0px; display: none;"></span><i class="icon-link"></i></li><li class="wmd-button btn btn-success" id="wmd-quote-button" title="引用 &lt;blockquote&gt; Ctrl/Cmd+Q" style="left: 0px;"><span style="background-position: -60px 0px; display: none;"></span><i class="icon-quote"></i></li><li class="wmd-button btn btn-success" id="wmd-code-button" title="代码片 &lt;pre&gt;&lt;code&gt; Ctrl/Cmd+K" style="left: 0px;"><span style="background-position: -80px 0px; display: none;"></span><i class="icon-code"></i></li><li class="wmd-button btn btn-success" id="wmd-image-button" title="图片 &lt;img&gt; Ctrl/Cmd+G" style="left: 0px;"><span style="background-position: -100px 0px; display: none;"></span><i class="icon-picture"></i></li><li class="wmd-button btn btn-success" id="wmd-olist-button" title="有序列表 &lt;ol&gt; Ctrl/Cmd+O" style="left: 0px;"><span style="background-position: -120px 0px; display: none;"></span><i class="icon-list-ordered"></i></li><li class="wmd-button btn btn-success" id="wmd-ulist-button" title="无序列表 &lt;ul&gt; Ctrl/Cmd+U" style="left: 0px;"><span style="background-position: -140px 0px; display: none;"></span><i class="icon-list-unordered"></i></li><li class="wmd-button btn btn-success" id="wmd-heading-button" title="标题 &lt;h1&gt;/&lt;h2&gt; Ctrl/Cmd+H" style="left: 0px;"><span style="background-position: -160px 0px; display: none;"></span><i class="icon-heading"></i></li><li class="wmd-button btn btn-success" id="wmd-hr-button" title="横线 &lt;hr&gt; Ctrl/Cmd+R" style="left: 0px;"><span style="background-position: -180px 0px; display: none;"></span><i class="icon-line"></i></li><li class="wmd-button disabled btn btn-success" id="wmd-undo-button" title="撤销 - Ctrl/Cmd+Z" style="left: 0px;"><span style="background-position: -200px -20px; display: none;"></span><i class="icon-undo"></i></li><li class="wmd-button disabled btn btn-success" id="wmd-redo-button" title="重做 - Ctrl/Cmd+Y" style="left: 0px;"><span style="background-position: -220px -20px; display: none;"></span><i class="icon-redo"></i></li></li>
                        ...
                        <li class="wmd-button-group3 btn-group">
                            <a data-toggle="modal" data-target=".modal-import-url" class="btn btn-success btn-import-online" title="从线上导入">
                                <i class="icon-earth"></i>
                            </a>
                            <a data-toggle="modal" data-target=".modal-import-harddrive-markdown" class="btn btn-success btn-import" title="从本机导入">
                                <i class="icon-hdd"></i>
                            </a>
                            <a data-toggle="modal" data-target=".modal-export-doc" class="btn btn-success btn-export" title="导出到本地">
			...
			<pre id="wmd-input" class="form-control font-rich" style="width: 784px; height: 479px;"><div class="editor-content" contenteditable="true" style="padding-left: 35px; padding-right: 35px; padding-bottom: 419px;"><span id="wmd-input-section-1" class="wmd-input-section"></span><span id="wmd-input-section-2" class="wmd-input-section"><span class="token h1"><span class="token md md-hash">#</span> 欢迎使用Markdown编辑器写博客</span><span class="token lf">
</span><span class="token lf">
</span><span class="token p">本Markdown编辑器使用<span class="token linkref"><span class="token ref-start"><span class="token md md-bracket-start">[</span><span class="token md md-underlined-text">StackEdit</span><span class="token md md-bracket-end">]</span></span><span class="token ref-end"><span class="token md md-bracket-start">[</span><span class="token md md-href">6</span><span class="token md md-bracket-end">]</span></span></span>修改而来，用它写博客，将会带来全新的体验哦：</span><span class="token lf">
</span><span class="token lf">
</span><span class="token li"><span class="token md md-li">- </span><span class="token strong"><span class="token md md-strong">**</span>Markdown和扩展Markdown简洁的语法<span class="token md md-strong">**</span></span><span class="token lf">
</span></span><span class="token li"><span class="token md md-li">- </span><span class="token strong"><span class="token md md-strong">**</span>代码块高亮<span class="token md md-strong">**</span></span><span class="token lf">
</span></span><span class="token li"><span class="token md md-li">- </span><span class="token strong"><span class="token md md-strong">**</span>图片链接和图片上传<span class="token md md-strong">**</span></span><span class="token lf">
</span></span><span class="token li"><span class="token md md-li">- </span><span class="token strong"><span class="token md md-strong">**</span>*LaTex*数学公式<span class="token md md-strong">**</span></span><span class="token lf">
</span></span><span class="token li"><span class="token md md-li">- </span><span class="token strong"><span class="token md md-strong">**</span>UML序列图和流程图<span class="token md md-strong">**</span></span><span class="token lf">
</span></span><span class="token li"><span class="token md md-li">- </span><span class="token strong"><span class="token md md-strong">**</span>离线写博客<span class="token md md-strong">**</span></span><span class="token lf">
</span></span><span class="token li"><span class="token md md-li">- </span><span class="token strong"><span class="token md md-strong">**</span>导入导出Markdown文件<span class="token md md-strong">**</span></span><span class="token lf">
</span></span><span class="token li"><span class="token md md-li">- </span><span class="token strong"><span class="token md md-strong">**</span>丰富的快捷键<span class="token md md-strong">**</span></span><span class="token lf">
</span><span class="token lf">
</span></span><span class="token hr">-------------------</span><span class="token lf">
</span><span class="token lf">
</span></span><span id="wmd-input-section-3" class="wmd-input-section"><span class="token h2"><span class="token md md-hash">##</span> 快捷键</span><span class="token lf">
</span><span class="token lf">
</span><span class="token li"><span class="token md md-li"> - </span>加粗    <span class="token code"><span class="token md md-code">`</span>Ctrl + B<span class="token md md-code">`</span></span> <span class="token lf">
</span><span class="token md md-li"> - </span>斜体    <span class="token code"><span class="token md md-code">`</span>Ctrl + I<span class="token md md-code">`</span></span> <span class="token lf">
</span><span class="token md md-li"> - </span>引用    <span class="token code"><span class="token md md-code">`</span>Ctrl + Q<span class="token md md-code">`</span></span><span class="token lf">
</span><span class="token md md-li"> - </span>插入链接    <span class="token code"><span class="token md md-code">`</span>Ctrl + L<span class="token md md-code">`</span></span><span class="token lf">
</span><span class="token md md-li"> - </span>插入代码    <span class="token code"><span class="token md md-code">`</span>Ctrl + K<span class="token md md-code">`</span></span><span class="token lf">
</span><span class="token md md-li"> - </span>插入图片    <span class="token code"><span class="token md md-code">`</span>Ctrl + G<span class="token md md-code">`</span></span><span class="token lf">
</span><span class="token md md-li"> - </span>提升标题    <span class="token code"><span class="token md md-code">`</span>Ctrl + H<span class="token md md-code">`</span></span><span class="token lf">
</span><span class="token md md-li"> - </span>有序列表    <span class="token code"><span class="token md md-code">`</span>Ctrl + O<span class="token md md-code">`</span></span><span class="token lf">
</span><span class="token md md-li"> - </span>无序列表    <span class="token code"><span class="token md md-code">`</span>Ctrl + U<span class="token md md-code">`</span></span><span class="token lf">
</span><span class="token md md-li"> - </span>横线    <span class="token code"><span class="token md md-code">`</span>Ctrl + R<span class="token md md-code">`</span></span><span class="token lf">
</span><span class="token md md-li"> - </span>撤销    <span class="token code"><span class="token md md-code">`</span>Ctrl + Z<span class="token md md-code">`</span></span><span class="token lf">
</span><span class="token md md-li"> - </span>重做    <span class="token code"><span class="token md md-code">`</span>Ctrl + Y<span class="token md md-code">`</span></span><span class="token lf">
</span><span class="token lf">
</span></span></span><span id="wmd-input-section-4" class="wmd-input-section"><span class="token h2"><span class="token md md-hash">##</span> Markdown及扩展</span><span class="token lf">
</span><span class="token lf">
</span><span class="token blockquote"><span class="token md md-gt">&gt; </span>Markdown 是一种轻量级标记语言，它允许人们使用易读易写的纯文本格式编写文档，然后转换成格式丰富的HTML页面。    —— &lt;a href="<span class="token url">https://zh.wikipedia.org/wiki/Markdown</span>" target="_blank"&gt; [ 维基百科 ]</span><span class="token lf">
</span><span class="token lf">
</span><span class="token p">使用简单的符号标识不同的标题，将某些文字标记为<span class="token strong"><span class="token md md-strong">**</span>粗体<span class="token md md-strong">**</span></span>或者<span class="token em"><span class="token md md-em md-start">*</span>斜体<span class="token md md-em md-close">*</span></span>，创建一个<span class="token link"><span class="token md md-bracket-start">[</span><span class="token md md-underlined-text">链接</span><span class="token md md-bracket-end">](</span><span class="token md md-href">http://www.csdn.net</span><span class="token md md-paren-end">)</span></span>等，详细语法参考帮助？。</span><span class="token lf">
</span><span class="token lf">
</span><span class="token p">本编辑器支持 <span class="token strong"><span class="token md md-strong">**</span>Markdown Extra<span class="token md md-strong">**</span></span> , 　扩展了很多好用的功能。具体请参考<span class="token linkref"><span class="token ref-start"><span class="token md md-bracket-start">[</span><span class="token md md-underlined-text">Github</span><span class="token md md-bracket-end">]</span></span><span class="token ref-end"><span class="token md md-bracket-start">[</span><span class="token md md-href">2</span><span class="token md md-bracket-end">]</span></span></span>.  </span><span class="token lf">
</span><span class="token lf">
</span></span><span id="wmd-input-section-5" class="wmd-input-section"><span class="token h3"><span class="token md md-hash">###</span> 表格</span><span class="token lf">
</span><span class="token lf">
</span><span class="token p"><span class="token strong"><span class="token md md-strong">**</span>Markdown　Extra<span class="token md md-strong">**</span></span>　表格语法：</span><span class="token lf">
</span><span class="token lf">
</span><span class="token table alt">项目     | 价格<span class="token lf">
</span>-------- | ---<span class="token lf">
</span>Computer | $1600<span class="token lf">
</span>Phone    | $12<span class="token lf">
</span>Pipe     | $1<span class="token lf">
</span><span class="token lf">
</span></span><span class="token p">可以使用冒号来定义对齐方式：</span><span class="token lf">
</span><span class="token lf">
</span><span class="token table">| 项目      |    价格 | 数量  |<span class="token lf">
</span>| :-------- | --------:| :--: |<span class="token lf">
</span>| Computer  | 1600 元 |  5   |<span class="token lf">
</span>| Phone     |   12 元 |  12  |<span class="token lf">
</span>| Pipe      |    1 元 | 234  |<span class="token lf">
</span><span class="token lf">
</span></span></span><span id="wmd-input-section-6" class="wmd-input-section"><span class="token h3"><span class="token md md-hash">###</span>定义列表</span><span class="token lf">
</span><span class="token lf">
</span><span class="token p"><span class="token strong"><span class="token md md-strong">**</span>Markdown　Extra<span class="token md md-strong">**</span></span>　定义列表语法：</span><span class="token lf">
</span><span class="token p">项目１</span><span class="token lf">
</span><span class="token p">项目２</span><span class="token lf">
</span><span class="token p">:   定义 A</span><span class="token lf">
</span><span class="token p">:   定义 B</span><span class="token lf">
</span><span class="token lf">
</span><span class="token p">项目３</span><span class="token lf">
</span><span class="token p">:   定义 C</span><span class="token lf">
</span><span class="token lf">
</span><span class="token p">:   定义 D</span><span class="token lf">
</span><span class="token lf">
</span><span class="token pre">	&gt; 定义D内容<span class="token lf">
</span></span><span class="token lf">
</span></span><span id="wmd-input-section-7" class="wmd-input-section"><span class="token h3"><span class="token md md-hash">###</span> 代码块</span><span class="token lf">
</span><span class="token p">代码块语法遵循标准markdown代码，例如：</span><span class="token lf">
</span></span><span id="wmd-input-section-8" class="wmd-input-section"><span class="token pre gfm"><span class="token md md-pre">```</span> python<span class="token lf">
</span>@requires_authorization<span class="token lf">
</span>def somefunc(param1='', param2=0):<span class="token lf">
</span>    '''A docstring'''<span class="token lf">
</span>    if param1 &gt; param2: # interesting<span class="token lf">
</span>        print 'Greater'<span class="token lf">
</span>    return (param2 - param1 + 1) or None<span class="token lf">
</span>class SomeClass:<span class="token lf">
</span>    pass<span class="token lf">
</span>&gt;&gt;&gt; message = '''interpreter<span class="token lf">
</span>... prompt'''<span class="token lf">
</span><span class="token md md-pre">```</span></span><span class="token lf">
</span><span class="token lf">
</span></span><span id="wmd-input-section-9" class="wmd-input-section"><span class="token h3"><span class="token md md-hash">###</span>脚注</span><span class="token lf">
</span><span class="token p">生成一个脚注<span class="token fn"><span class="token ref"><span class="token md md-bracket-start">[</span><span class="token md md-ref">^footnote</span><span class="token md md-bracket-end">]</span></span></span>.</span><span class="token lf">
</span><span class="token fndef">  <span class="token ref-id"><span class="token md md-bracket-start">[</span>^footnote<span class="token md md-bracket-end">]</span></span>: 这里是 <span class="token strong"><span class="token md md-strong">**</span>脚注<span class="token md md-strong">**</span></span> 的 <span class="token em"><span class="token md md-em md-start">*</span>内容<span class="token md md-em md-close">*</span></span>.</span><span class="token lf">
</span><span class="token p">  </span><span class="token lf">
</span></span><span id="wmd-input-section-10" class="wmd-input-section"><span class="token h3"><span class="token md md-hash">###</span> 目录</span><span class="token lf">
</span><span class="token p">用 <span class="token code"><span class="token md md-code">`</span>[TOC]<span class="token md md-code">`</span></span>来生成目录：</span><span class="token lf">
</span><span class="token lf">
</span><span class="token p"><span class="token md md-toc">[TOC]</span></span><span class="token lf">
</span><span class="token lf">
</span></span><span id="wmd-input-section-11" class="wmd-input-section"><span class="token h3"><span class="token md md-hash">###</span> 数学公式</span><span class="token lf">
</span><span class="token p">使用MathJax渲染<span class="token em"><span class="token md md-em md-start">*</span>LaTex<span class="token md md-em md-close">*</span></span> 数学公式，详见<span class="token linkref"><span class="token ref-start"><span class="token md md-bracket-start">[</span><span class="token md md-underlined-text">math.stackexchange.com</span><span class="token md md-bracket-end">]</span></span><span class="token ref-end"><span class="token md md-bracket-start">[</span><span class="token md md-href">1</span><span class="token md md-bracket-end">]</span></span></span>.</span><span class="token lf">
</span><span class="token lf">
</span><span class="token li"><span class="token md md-li"> - </span>行内公式，数学公式为：<span class="token math"><span class="token md md-bracket-start">$</span><span class="token keyword">\Gamma</span><span class="token lparen">(</span>n<span class="token rparen">)</span> = <span class="token lparen">(</span>n-1<span class="token rparen">)</span>!<span class="token keyword">\quad</span><span class="token keyword">\forall</span> n<span class="token keyword">\in</span><span class="token keyword">\mathbb</span> N<span class="token md md-bracket-end">$</span></span>。<span class="token lf">
</span><span class="token md md-li"> - </span>块级公式：<span class="token lf">
</span></span></span><span id="wmd-input-section-12" class="wmd-input-section"><span class="token lf">
</span><span class="token math block"><span class="token md md-bracket-start">$$</span>	x = <span class="token keyword">\dfrac</span><span class="token lparen">{</span>-b <span class="token keyword">\pm</span> <span class="token keyword">\sqrt</span><span class="token lparen">{</span>b^2 - 4ac<span class="token rparen">}</span><span class="token rparen">}</span><span class="token lparen">{</span>2a<span class="token rparen">}</span> <span class="token md md-bracket-end">$$</span></span><span class="token lf">
</span><span class="token lf">
</span><span class="token p">更多LaTex语法请参考 <span class="token linkref"><span class="token ref-start"><span class="token md md-bracket-start">[</span><span class="token md md-underlined-text">这儿</span><span class="token md md-bracket-end">]</span></span><span class="token ref-end"><span class="token md md-bracket-start">[</span><span class="token md md-href">3</span><span class="token md md-bracket-end">]</span></span></span>.</span><span class="token lf">
</span><span class="token lf">
</span></span><span id="wmd-input-section-13" class="wmd-input-section"><span class="token h3"><span class="token md md-hash">###</span> UML 图:</span><span class="token lf">
</span><span class="token lf">
</span><span class="token p">可以渲染序列图：</span><span class="token lf">
</span><span class="token lf">
</span></span><span id="wmd-input-section-14" class="wmd-input-section"><span class="token pre gfm"><span class="token md md-pre">```</span>sequence<span class="token lf">
</span>张三-&gt;李四: 嘿，小四儿, 写博客了没?<span class="token lf">
</span>Note right of 李四: 李四愣了一下，说：<span class="token lf">
</span>李四--&gt;张三: 忙得吐血，哪有时间写。<span class="token lf">
</span><span class="token md md-pre">```</span></span><span class="token lf">
</span><span class="token lf">
</span><span class="token p">或者流程图：</span><span class="token lf">
</span><span class="token lf">
</span></span><span id="wmd-input-section-15" class="wmd-input-section"><span class="token pre gfm"><span class="token md md-pre">```</span>flow<span class="token lf">
</span>st=&gt;start: 开始<span class="token lf">
</span>e=&gt;end: 结束<span class="token lf">
</span>op=&gt;operation: 我的操作<span class="token lf">
</span>cond=&gt;condition: 确认？<span class="token lf">
</span><span class="token lf">
</span>st-&gt;op-&gt;cond<span class="token lf">
</span>cond(yes)-&gt;e<span class="token lf">
</span>cond(no)-&gt;op<span class="token lf">
</span><span class="token md md-pre">```</span></span><span class="token lf">
</span><span class="token lf">
</span><span class="token li"><span class="token md md-li">- </span>关于 <span class="token strong"><span class="token md md-strong">**</span>序列图<span class="token md md-strong">**</span></span> 语法，参考 <span class="token linkref"><span class="token ref-start"><span class="token md md-bracket-start">[</span><span class="token md md-underlined-text">这儿</span><span class="token md md-bracket-end">]</span></span><span class="token ref-end"><span class="token md md-bracket-start">[</span><span class="token md md-href">4</span><span class="token md md-bracket-end">]</span></span></span>,<span class="token lf">
</span></span><span class="token li"><span class="token md md-li">- </span>关于 <span class="token strong"><span class="token md md-strong">**</span>流程图<span class="token md md-strong">**</span></span> 语法，参考 <span class="token linkref"><span class="token ref-start"><span class="token md md-bracket-start">[</span><span class="token md md-underlined-text">这儿</span><span class="token md md-bracket-end">]</span></span><span class="token ref-end"><span class="token md md-bracket-start">[</span><span class="token md md-href">5</span><span class="token md md-bracket-end">]</span></span></span>.<span class="token lf">
</span><span class="token lf">
</span></span></span><span id="wmd-input-section-16" class="wmd-input-section"><span class="token h2"><span class="token md md-hash">##</span> 离线写博客</span><span class="token lf">
</span><span class="token lf">
</span><span class="token p">即使用户在没有网络的情况下，也可以通过本编辑器离线写博客（直接在曾经使用过的浏览器中输入<span class="token link"><span class="token md md-bracket-start">[</span><span class="token md md-underlined-text">write.blog.csdn.net/mdeditor</span><span class="token md md-bracket-end">](</span><span class="token md md-href">http://write.blog.csdn.net/mdeditor</span><span class="token md md-paren-end">)</span></span>即可。<span class="token strong"><span class="token md md-strong">**</span>Markdown编辑器<span class="token md md-strong">**</span></span>使用浏览器离线存储将内容保存在本地。</span><span class="token lf">
</span><span class="token lf">
</span><span class="token p">用户写博客的过程中，内容实时保存在浏览器缓存中，在用户关闭浏览器或者其它异常情况下，内容不会丢失。用户再次打开浏览器时，会显示上次用户正在编辑的没有发表的内容。</span><span class="token lf">
</span><span class="token lf">
</span><span class="token p">博客发表后，本地缓存将被删除。　</span><span class="token lf">
</span><span class="token lf">
</span><span class="token p">用户可以选择 <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>i</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation">=</span><span class="token punctuation">"</span>icon-disk<span class="token punctuation">"</span></span><span class="token punctuation">&gt;</span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>i</span><span class="token punctuation">&gt;</span></span> 把正在写的博客保存到服务器草稿箱，即使换浏览器或者清除缓存，内容也不会丢失。</span><span class="token lf">
</span><span class="token lf">
</span><span class="token blockquote"><span class="token md md-gt">&gt; </span><span class="token strong"><span class="token md md-strong">**</span>注意：<span class="token md md-strong">**</span></span>虽然浏览器存储大部分时候都比较可靠，但为了您的数据安全，在联网后，<span class="token strong"><span class="token md md-strong">**</span>请务必及时发表或者保存到服务器草稿箱<span class="token md md-strong">**</span></span>。</span><span class="token lf">
</span><span class="token lf">
</span></span><span id="wmd-input-section-17" class="wmd-input-section"><span class="token h2"><span class="token md md-hash">##</span>浏览器兼容</span><span class="token lf">
</span><span class="token lf">
</span><span class="token li"><span class="token md md-li"> 1. </span>目前，本编辑器对Chrome浏览器支持最为完整。建议大家使用较新版本的Chrome。<span class="token lf">
</span><span class="token md md-li"> 3. </span>IE９以下不支持<span class="token lf">
</span><span class="token md md-li"> 4. </span>IE９，１０，１１存在以下问题<span class="token lf">
</span><span class="token md md-li">    1. </span>不支持离线功能<span class="token lf">
</span><span class="token md md-li">    1. </span>IE9不支持文件导入导出<span class="token lf">
</span><span class="token md md-li">    1. </span>IE10不支持拖拽文件导入<span class="token lf">
</span><span class="token lf">
</span></span><span class="token hr">---------</span><span class="token lf">
</span><span class="token lf">
</span><span class="token linkdef"><span class="token link-id"><span class="token md md-bracket-start">[</span>1<span class="token md md-bracket-end">]</span></span>: <span class="token url">http://math.stackexchange.com/</span></span><span class="token lf">
</span><span class="token linkdef"><span class="token link-id"><span class="token md md-bracket-start">[</span>2<span class="token md md-bracket-end">]</span></span>: <span class="token url">https://github.com/jmcmanus/pagedown-extra</span> <span class="token linktitle">"Pagedown Extra"</span></span><span class="token lf">
</span><span class="token linkdef"><span class="token link-id"><span class="token md md-bracket-start">[</span>3<span class="token md md-bracket-end">]</span></span>: <span class="token url">http://meta.math.stackexchange.com/questions/5020/mathjax-basic-tutorial-and-quick-reference</span></span><span class="token lf">
</span><span class="token linkdef"><span class="token link-id"><span class="token md md-bracket-start">[</span>4<span class="token md md-bracket-end">]</span></span>: <span class="token url">http://bramp.github.io/js-sequence-diagrams/</span></span><span class="token lf">
</span><span class="token linkdef"><span class="token link-id"><span class="token md md-bracket-start">[</span>5<span class="token md md-bracket-end">]</span></span>: <span class="token url">http://adrai.github.io/flowchart.../../statics/js/</span></span><span class="token lf">
</span><span class="token linkdef"><span class="token link-id"><span class="token md md-bracket-start">[</span>6<span class="token md md-bracket-end">]</span></span>: <span class="token url">https://github.com/benweet/stackedit</span></span></span><span class="token lf">
</span></div><div class="editor-margin" style="width: 35px;"></div></pre>
                    <div class="preview-panel" style="transform: translate(784px, 0px); width: 816px; height: 479px;">
                        <div class="layout-resizer layout-resizer-preview open" style="user-select: none; -webkit-user-drag: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0); touch-action: pan-y; height: 479px;"></div>
                        <div class="layout-toggler layout-toggler-navbar btn btn-info hide open" title="头部收起/展开" style="height: 60px;">
                        </div>
                        <div class="layout-toggler layout-toggler-preview btn open" title="预览区显示/隐藏（可拖拽）" style="line-height: 60px; vertical-align: middle; outline: none; transform: translate(0px, 209.5px); height: 60px;">
                            <svg viewBox="0 0 1024 1024" width="22" height="22" style=" display: inline-block; vertical-align: middle;">&gt;
                                <path d="M704 512a22.56 22.56 0 0 0-6.656-15.136l-307.456-307.488a22.72 22.72 0 0 0-15.136-6.56 22.592 22.592 0 0 0-15.136 6.56L326.592 222.4a22.72 22.72 0 0 0-6.56 15.136c0 5.28 2.624 11.232 6.56 15.136L585.888 512l-259.328 259.328a22.72 22.72 0 0 0-6.56 15.136c0 5.952 2.624 11.232 6.56 15.136l33.024 33.024a22.688 22.688 0 0 0 15.136 6.56 22.592 22.592 0 0 0 15.136-6.56l307.488-307.488A22.432 22.432 0 0 0 704 512z" fill="#d6d6d6" p-id="7154"></path>
                            </svg>
                        </div>
                        <div class="preview-container" style="left: 32px; width: 784px; height: 479px;">
                            <div id="preview-contents" style="padding-left: 35px; padding-right: 35px; padding-bottom: 419px;">
                                <div id="wmd-preview" class="preview-content markdown_views"></div>
                                <div id="wmd-preview-section-1" class="wmd-preview-section preview-content markdown_views">

                                </div><div id="wmd-preview-section-2" class="wmd-preview-section preview-content markdown_views">
                            ...
                            </div><div id="wmd-preview-section-3" class="wmd-preview-section preview-content markdown_views">
                            ...
                            </div><div id="wmd-preview-section-4" class="wmd-preview-section preview-content markdown_views">
                            ...
                            </div><div id="wmd-preview-section-5" class="wmd-preview-section preview-content markdown_views">
                            ...
                            </div><div id="wmd-preview-section-6" class="wmd-preview-section preview-content markdown_views">
                            ...
                            </div><div id="wmd-preview-section-7" class="wmd-preview-section preview-content markdown_views">

                                <h3 id="代码块">代码块</h3>

                                <p>代码块语法遵循标准markdown代码，例如：</p>

                            </div><div id="wmd-preview-section-8" class="wmd-preview-section preview-content markdown_views">
...
<span class="hljs-prompt">... </span>prompt'''</span></code></pre>
                            ...
                            </div><div id="wmd-preview-section-9" class="wmd-preview-section preview-content markdown_views">

                                <h3 id="脚注">脚注</h3>

                                <p>生成一个脚注<a href="http://mp.blog.csdn.net/mdeditor#fn:footnote" id="fnref:footnote" title="See footnote" class="footnote">1</a>.</p>

                            </div><div id="wmd-preview-section-10" class="wmd-preview-section preview-content markdown_views">
                                ...
                                <p><div class="toc">
                                <ul>
                                    <li><a href="http://mp.blog.csdn.net/mdeditor#%E6%AC%A2%E8%BF%8E%E4%BD%BF%E7%94%A8markdown%E7%BC%96%E8%BE%91%E5%99%A8%E5%86%99%E5%8D%9A%E5%AE%A2">欢迎使用Markdown编辑器写博客</a><ul>
                                        <li><a href="http://mp.blog.csdn.net/mdeditor#%E5%BF%AB%E6%8D%B7%E9%94%AE">快捷键</a></li>
                                        <li><a href="http://mp.blog.csdn.net/mdeditor#markdown%E5%8F%8A%E6%89%A9%E5%B1%95">Markdown及扩展</a><ul>
                                            <li><a href="http://mp.blog.csdn.net/mdeditor#%E8%A1%A8%E6%A0%BC">表格</a></li>
                                            <li><a href="http://mp.blog.csdn.net/mdeditor#%E5%AE%9A%E4%B9%89%E5%88%97%E8%A1%A8">定义列表</a></li>
                                            <li><a href="http://mp.blog.csdn.net/mdeditor#%E4%BB%A3%E7%A0%81%E5%9D%97">代码块</a></li>
                                            <li><a href="http://mp.blog.csdn.net/mdeditor#%E8%84%9A%E6%B3%A8">脚注</a></li>
                                            <li><a href="http://mp.blog.csdn.net/mdeditor#%E7%9B%AE%E5%BD%95">目录</a></li>
                                            <li><a href="http://mp.blog.csdn.net/mdeditor#%E6%95%B0%E5%AD%A6%E5%85%AC%E5%BC%8F">数学公式</a></li>
                                            <li><a href="http://mp.blog.csdn.net/mdeditor#uml-%E5%9B%BE">UML 图:</a></li>
                                        </ul>
                                        </li>
                                        <li><a href="http://mp.blog.csdn.net/mdeditor#%E7%A6%BB%E7%BA%BF%E5%86%99%E5%8D%9A%E5%AE%A2">离线写博客</a></li>
                                        <li><a href="http://mp.blog.csdn.net/mdeditor#%E6%B5%8F%E8%A7%88%E5%99%A8%E5%85%BC%E5%AE%B9">浏览器兼容</a></li>
                                    </ul>
                                    </li>
                                </ul>
                            </div>
                            ...
                            </div><div id="wmd-preview-section-11" class="wmd-preview-section preview-content markdown_views">
                            ...
                            </div><div id="wmd-preview-section-17" class="wmd-preview-section preview-content markdown_views">
                            ...
                            </div><div id="wmd-preview-section-footnotes" class="preview-content markdown_views"><div class="footnotes"><hr><ol><li id="fn:footnote">这里是 <strong>脚注</strong> 的 <em>内容</em>. <a href="http://mp.blog.csdn.net/mdeditor#fnref:footnote" title="Return to article" class="reversefootnote">↩</a></li></ol></div></div></div>
                        </div>
                    </div>
                </div>
                <div class="extension-preview-buttons animate closed" style="user-select: none; -webkit-user-drag: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0); touch-action: pan-y; transform: translate(79px, -6px);">
            ...
            <div class="document-panel">
                <div class="panel-content">
                    <div class="list-group document-list"><ul class="nav"><li><a href="http://mp.blog.csdn.net/mdeditor#" class="list-group-item file active" data-file-index="file.RYJeVEvlvqmBQBDANkSAi84r">   <i class="icon-provider-csdnblog"></i>欢迎使用CSDN-markdown编辑器</a></li></ul></div>
                    <div class="list-group document-list-filtered hide"><ul class="nav"><li><a href="http://mp.blog.csdn.net/mdeditor#" class="list-group-item file active" data-file-index="file.RYJeVEvlvqmBQBDANkSAi84r">   <i class="icon-provider-csdnblog"></i>欢迎使用CSDN-markdown编辑器</a></li></ul></div>
                </div>
            </div>
        </div>
                        ...
                        <div class="modal-header clearfix">
                            ...
                            <ul class="nav nav-tabs pull-right" role="tablist">
                                <li role="presentation" class="active">
                                    <a href="http://mp.blog.csdn.net/mdeditor#img_upload" role="tab" data-toggle="tab">上传图片</a>
                                </li>
                                <li role="presentation">
                                    <a href="http://mp.blog.csdn.net/mdeditor#img_online" role="tab" data-toggle="tab">URL上传</a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <div role="tabpanel" class="tab-pane active" id="img_upload">
                                <div class="modal-body">
                                    <label for="fileImgUpload" class="btn-outline-danger btn-file-upload">
                                        上传图片
                                        <input type="file" name="" id="fileImgUpload" accept="image/png,image/gif,image/jpeg">
                                    </label>
                                </div>
                                <div class="modal-footer">
                            ...
                            <ol class="help-menu">
                                ...
                                <li>
                                    ...
                                    <div>
                                        <h4>使用MathJax渲染*LaTex* 数学公式，详见[
                                            <a href="http://math.stackexchange.com/" target="_blank">math.stackexchange.com</a>]
                                        </h4>
                                        <h4>行内公式，数学公式为：</h4>
                                        ...
                                        <p>更多LaTex语法请参考 [
                                            <a href="http://meta.math.stackexchange.com/questions/5020/mathjax-basic-tutorial-and-quick-reference" target="_blank">这儿</a>]。</p>
                                ...
                                <li>
                                    ...
                                    <div>
                                        ...
                                        <p>- 关于 **序列图** 语法，参考 [
                                            <a href="http://bramp.github.io/js-sequence-diagrams/" target="_blank">这儿</a>]
                                            <br> - 关于 **流程图** 语法，参考 [
                                            <a href="http://adrai.github.io/flowchart.../../statics/js/" target="_blank">这儿</a>]
                                            <br>
                                        </p>
                                    </div>
                                </li>
...
<div style="position:fixed; top:0; left:0; overflow:hidden;"><input style="position:absolute; left:-300px;" type="text" value="" id="focus_retriever" readonly="true"></div><i title="Raphaël Colour Picker" style="display: none; color: white;"></i><div style="position: absolute; width: 0px; height: 0px; overflow: hidden; padding: 0px; border: 0px; margin: 0px;"><div id="MathJax_Font_Test" style="position: absolute; visibility: hidden; top: 0px; left: 0px; width: auto; padding: 0px; border: 0px; margin: 0px; white-space: nowrap; text-align: left; text-indent: 0px; text-transform: none; line-height: normal; letter-spacing: normal; word-spacing: normal; font-size: 40px; font-weight: normal; font-style: normal; font-family: MathJax_AMS, sans-serif;"></div></div></body><input style="width:1px;height:1px;border:none;margin:0;padding:0;" tabindex="-1"></html>
